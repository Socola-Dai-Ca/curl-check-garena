...
$curl->get('https://sso.garena.com/api/login?account=' . $user . '&password=' . $pass . '&redirect_uri=https%3A%2F%2Faccount.garena.com%2F&format=json&id=' . $token['id'] . '&app_id=10100');
